...
const CONFIG_PATH = process.env.ARIA2_CONFIG ||
  path.resolve(process.cwd(), '.aria2-config.json') ||
  path.resolve(process.env.HOME || process.env.USERPROFILE || '/', '.aria2-config.json');
